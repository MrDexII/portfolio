...
function Footer() {
    return (
        <div className={styles.container}>
            ...
            <ul>
                <li><a href="#pokemon">Pokemon REST</a></li>
                <li><a href="#game">Gra</a></li>
                <li><a href="#scraping">Web scraping</a></li>
                <li><a href="#computing">Obliczenia ewolucyjne</a></li>
            </ul>
                <div className={styles.links}>
                    ...
                    <a href="#contact">
                        <span>
                            <svg width="24" height="24" viewBox="0 0 24 24">
                                <path d="m20 22.6l-3.5-6.8c0 0-2 1-2.1 1 -2.2 1.1-6.8-7.8-4.6-9l2.1-1 -3.5-6.8 -2.1 1c-7.2 3.8 4.2 26 11.6 22.6 0.1-0.1 2.1-1 2.1-1z" /></svg>
                        </span>
                    </a>
                </div>
            </div>
